                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="leave.php" aria-expanded="true"><i class="ti-user"></i><span>Apply LOR
                                    </span></a>
                            </li>

                            <li class="#">
                                <a href="leave-history.php" aria-expanded="true"><i class="ti-agenda"></i><span>View My LOR History
                                    </span></a>
                            </li>
                            <li class="#">
                                <a href="docupload.php" aria-expanded="true"><i class="ti-agenda"></i><span>Upload Documents
                                    </span></a>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Apply For LOR</h4>
                            <ul class="breadcrumbs pull-left">
                                
                                <li><span>LOR Form</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">Student LOR Form</h4>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Your Higher Studies Exam Type</label>
