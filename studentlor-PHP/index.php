<?php
    ...
    if(isset($_POST['signin']))
    {
        ...
        $sql ="SELECT EmailId,Password,Status,id FROM studentlor WHERE EmailId=:uname and Password=:password";
            ...
            if($status==0)
        {
            ...
            echo "<script type='text/javascript'> document.location = 'student/lor.php'; </script>";
        }
            }   else  {
...
<head>
    ...
    <title>Letter of RecommendationSystemfor DBIT Student’s Higher Studies</title>
                ...
                <form method="POST" name="signin">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="admin/index.php">Faculty LOGIN</a></p>
                            <p class="text-muted"><a href="hod/index.php">HOD LOGIN</a></p>
                        </div>
                    </div>
                </form>
            </div>
