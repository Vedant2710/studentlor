<nav>
        ...
        <li class="<?php if($page=='employee') {echo 'active';} ?>"><a href="employees.php"><i class="ti-id-badge"></i> <span>Student Section</span></a></li>
        ...
        <li class="<?php if($page=='department') {echo 'active';} ?>"><a href="department.php"><i class="fa fa-th-large"></i> <span>Department Section</span></a></li>
         ...
         <li class="<?php if($page=='leave') {echo 'active';} ?>"><a href="leave-section.php"><i class="fa fa-sign-out"></i> <span>Exam Types</span></a></li>
         <li class="<?php if($page=='file') {echo 'active';} ?>"><a href="downloads.php"><i class="fa fa-sign-out"></i> <span>Uploaded files</span></a></li>

        <li class="<?php if($page=='manage-leave') {echo 'active';} ?>">
            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-briefcase"></i><span>Manage LOR's</span></a>
            ...
            <ul class="collapse">
                ...
                <li ><a href="leave-history.php"><i class="fa fa-history"></i> LOR History</a></li>
            </ul>
